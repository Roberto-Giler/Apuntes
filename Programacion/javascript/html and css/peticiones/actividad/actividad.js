...
function mostrarMensaje(resultadoRonda){
    console.log(resultadoRonda)
    alert(resultadoRonda)
    if(resultadoRonda==='Una lástima, perdiste.'){
        alert('Pero no te desanimes, de seguro lo lograras!!!')
    }
...
while(seguirJugando){
    ...
    mostrarMensaje(resultadoDePartida)
    seguirJugando=confirm('¿Desea seguir jugando?')
}
